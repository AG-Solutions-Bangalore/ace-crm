...
import { ButtonConfig } from "@/config/ButtonConfig"; // Import the ButtonConfig
    ...
    <Page>
      <div className="w-full p-4">
        ...
        <div className="flex items-center py-4">
          ...
          <Button
            variant="default"
            className={`ml-2 ${ButtonConfig.primary.backgroundColor} ${ButtonConfig.primary.textColor} ${ButtonConfig.primary.hoverBackgroundColor}`}
                ...
                <TableRow key={headerGroup.id}>
                  {headerGroup.headers.map((header) => {
                    return (
                      <TableHead
                        key={header.id}
                        className={`text-black ${ButtonConfig.primary.backgroundColor}`}
                      >
