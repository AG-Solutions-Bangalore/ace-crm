...
const ViewContract = () => {
 ...
 useEffect(() => {
  ...
  const handleSaveAsWidthoutHeaderPdf = () => {
    ...
    const element = HeaderWithSignRef.current;
    ...
    <Page>
      <div className=" flex w-full p-2 gap-2 relative ">
        <div className="w-[85%]">
          ...
          <div ref={HeaderWithSignRef} className="    min-h-screen font-normal ">
       ...
       {/* only for print  */}
          <div ref={withoutHeaderSignRef} className=" hidden print:block    min-h-screen font-normal ">
