...
const EditMarketProduction = () => {
  ...
  useEffect(() => {
    if (MarketProductionData) {
      ...
      setContractData(MarketProductionData.marketproduction);
    }
              ...
              <div className="grid grid-cols-3 gap-6 mt-3">
                <div className="flex flex-col gap-2">
                  <MemoizedProductSelect
                    ...
                    onChange={(value) =>
                      handleRowDataChange(rowIndex, "mpr_product_name", value)
                    }
                    options={
                ...
                <div className="flex flex-col gap-2">
                  <Input
                    ...
                    value={row.mpr_bag}
                    onChange={(e) =>
                      handleRowDataChange(rowIndex, "mpr_bag", e.target.value)
                    }
                ...
                <div className="flex flex-col gap-2">
                  <Input
                    ...
                    value={row.mpr_qnty}
                    onChange={(e) =>
                      handleRowDataChange(rowIndex, "mpr_qnty", e.target.value)
                    }
