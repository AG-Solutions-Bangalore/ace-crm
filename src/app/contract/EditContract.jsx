...
import { PlusCircle, MinusCircle, ChevronDown, Trash2, Loader2 } from "lucide-react";
    ...
    const { toast } = useToast();
       ...
       useEffect(() => {
          if (contractDatas) {
            setFormData({
              ...
              contract_destination_port: contractDatas.contract.contract_destination_port,
              contract_discharge: contractDatas.contract.contract_discharge,
              contract_cif: contractDatas.contract.contract_cif,
              contract_destination_country: contractDatas.contract.contract_destination_country,
      ...
      const handleSubmit = async (e) => {
          ...
          try {
            ...
            updateContractMutation.mutate({ id, data: validatedData });
          } catch (error) {
