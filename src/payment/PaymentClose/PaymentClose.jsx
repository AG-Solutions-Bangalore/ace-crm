...
const PaymentClose = () => {
  ...
  <div className="flex items-center space-x-6 text-sm text-muted-foreground">
    <div>
      <span className="font-medium text-gray-800">Total Payment Close:</span>{" "}
    ...
    <div>
      <span className="font-medium text-gray-800">Total Received:</span>{" "}
      {table
        .getFilteredRowModel()
        .rows.reduce(
          (sum, row) => sum + Number(row.original.received || 0),
          0
        )
        .toFixed(2)}
    </div>
