  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <div className="relative group">
        ...
        <motion.div
          initial={false}
          className="flex flex-col items-center mb-3 space-y-3 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 pointer-events-none group-hover:pointer-events-auto absolute bottom-full"
        >
          {/* WhatsApp */}
          <a
            href={whatsappLink}
        ...
        {/* Trigger button */}
        <div className="w-14 h-14 cursor-pointer bg-amber-500 hover:bg-amber-600 text-white rounded-full shadow-xl flex items-center justify-center transition duration-300 group">
          <MessageCircle size={24} />
        </div>
      </div>
    </div>
